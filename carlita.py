...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6295991904:AAEozakJvciFZpqeGb4N3Ir1usEiuRTL1wE"
else:
    tgkey = tgenv
print(tgenv)
...
chat_log = None
botname = 'Carlita Ky'
username = 'Sweet_Sweet_Carlita_bot'
